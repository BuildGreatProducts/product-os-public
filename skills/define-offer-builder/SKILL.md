...
If the member has no idea at all — a business or expertise but nothing to describe — stop and run `define-leverage-finder` first; it ends with these two questions answered.
