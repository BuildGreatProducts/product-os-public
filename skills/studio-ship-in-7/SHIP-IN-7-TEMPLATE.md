...
| Day | Date | Block | Result | Proof | Blocker |
| --- | --- | --- | --- | --- | --- |
...
*Gaps (days between sessions) are noted in the Date column, e.g. "Mon 14th (3-day gap)". Plan changes: [dated one-liners].*
