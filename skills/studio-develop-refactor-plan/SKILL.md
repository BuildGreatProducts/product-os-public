---
name: studio-develop-refactor-plan
...
- **Agent Session Guide** matching the roadmap's: read selectively via Reference sections, never skip tasks, update the status line, commit and push at each phase boundary.
