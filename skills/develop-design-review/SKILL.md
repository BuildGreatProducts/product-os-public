...
*Reviewed: [Month Day, Year at HH:MM]. Scope: uncommitted changes in [N] UI files against `docs/DESIGN.md`. Generated by `develop-design-review`.*
...
- **`docs/DESIGN.md` missing or unparseable.** Stop. Tell the user to run `design-design-system` to create the file, or to fix the YAML errors before re-running.
