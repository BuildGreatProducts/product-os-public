...
| 2. **Design** | `productos/design/` | Identity (in words), UX writing guide, design system from an image you love, magic moment, onboarding, relaunch #2 → `docs/COPY.md`, `docs/DESIGN.md` + `docs/DESIGN.html` |
