...
ProductOS is also a plugin for **Claude Code**, **Codex**, and **Cursor** — one package, three manifests, the same 38 skills:
...
- **`productos/skills/`** — one flat folder per skill (38 total). Each contains a `SKILL.md` plus any bundled reference files.
...
**1.9.0** — see `productos/CHANGELOG.md`. Licensed for individual commercial use — see `productos/LICENSE.md`.
